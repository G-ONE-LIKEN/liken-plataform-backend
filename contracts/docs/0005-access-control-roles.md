...
## Contexto
El sistema tiene multiples actores con permisos distintos sobre los mismos contratos:
...
- Los desarrolladores registrados necesitan poder crear proyectos sin requerir
  aprobacion manual del admin por cada operacion.

Ownable solo permite un unico owner, lo que obliga a elegir entre darle control
total al creador o a la plataforma, sin poder tener ambos con permisos acotados.

## Decision
Usar OpenZeppelin AccessControl con roles explicitos en lugar de Ownable:
...
- Los roles son revocables individualmente: se puede quitar MINTER_ROLE a un creador
  sin afectar PAUSER_ROLE ni los demas roles.
