 ...
 *   <li>Mantener un checkpoint del último bloque procesado para reanudar tras restart
 ...
 * (registerProject, grantRole, depositDividends, deploy de OfferingContract) sí
