 ...
 *   X-User-Role        — nombre del rol (ej. "ADMIN", "DEVELOPER")
...
public class GatewayHeaderAuthFilter extends OncePerRequestFilter {
    ...
    private static final String HEADER_DEV_STATUS     = "X-Developer-Status";
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (userIdHeader != null && !userIdHeader.isBlank()) {
            try {
                ...
                String devStatus = request.getHeader(HEADER_DEV_STATUS);
                ...
                // Developer aprobado recibe autoridad especial para crear proyectos
                if ("APPROVED".equals(devStatus)) {
                    authorities.add(new SimpleGrantedAuthority("developer:approved"));
                }
