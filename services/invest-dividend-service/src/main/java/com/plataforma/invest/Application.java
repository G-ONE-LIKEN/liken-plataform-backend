 ...
 *   <li><b>Acumular inversion total por usuario</b> y recalcular el tier
 ...
 *   <li><b>Preview de compra</b>: calcula cuantos LKN recibe el inversor por una
 ...
 * para una operacion admin firmada (fuera del alcance de esta fase).
 */
@SpringBootApplication
// El SecurityConfig + GatewayHeaderAuthFilter viven en `com.plataforma.shared.*`
// (mismo patron que wallet-service). Sin este scan explicito, Spring Boot solo
