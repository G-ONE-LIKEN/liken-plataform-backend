 ...
 *  3. Enviar {@code walletAddress} + {@code signature} (hex 0x... de 65 bytes) acá.
 *
 * El backend verifica con ecrecover que la firma corresponda a la wallet
 * declarada. Si todo encaja, persiste la dirección en EIP-55 checksum.
 */
@Data
@Builder
@AllArgsConstructor
...
public class WalletLinkRequest {
    /** Dirección 0x + 40 hex chars. Cualquier casing — se normaliza a EIP-55. */
